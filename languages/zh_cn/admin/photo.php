...
$_LANG['edit_goods'] = '编辑图库信息';
$_LANG['copy_goods'] = '复制图库信息';
$_LANG['continue_add_goods'] = '继续添加新图库';
$_LANG['back_goods_list'] = '返回图库列表';
$_LANG['add_goods_ok'] = '添加图库成功。';
$_LANG['edit_goods_ok'] = '编辑图库成功。';
$_LANG['trash_goods_ok'] = '把图库放入回收站成功。';
$_LANG['restore_goods_ok'] = '还原图库成功。';
$_LANG['drop_goods_ok'] = '删除图库成功。';
$_LANG['batch_handle_ok'] = '批量操作成功。';
$_LANG['drop_goods_confirm'] = '您确实要删除该图库吗？';
$_LANG['batch_drop_confirm'] = '彻底删除图库将删除与该图库有关的所有信息。\n您确实要删除选中的图库吗？';
$_LANG['trash_goods_confirm'] = '您确实要把该图库放入回收站吗？';
$_LANG['trash_product_confirm'] = '您确实要把该货品删除吗？';
$_LANG['batch_trash_confirm'] = '您确实要把选中的图库放入回收站吗？';
$_LANG['restore_goods_confirm'] = '您确实要把该图库还原吗？';
$_LANG['batch_restore_confirm'] = '您确实要把选中的图库还原吗？';
$_LANG['batch_on_sale_confirm'] = '您确实要把选中的图库上架吗？';
$_LANG['batch_not_on_sale_confirm'] = '您确实要把选中的图库下架吗？';
$_LANG['batch_best_confirm'] = '您确实要把选中的图库设为精品吗？';
$_LANG['batch_not_best_confirm'] = '您确实要把选中的图库取消精品吗？';
$_LANG['batch_new_confirm'] = '您确实要把选中的图库设为新品吗？';
$_LANG['batch_not_new_confirm'] = '您确实要把选中的图库取消新品吗？';
$_LANG['batch_hot_confirm'] = '您确实要把选中的图库设为热销吗？';
$_LANG['batch_not_hot_confirm'] = '您确实要把选中的图库取消热销吗？';
$_LANG['cannot_found_goods'] = '找不到指定的图库。';
$_LANG['sel_goods_type'] = '请选择图库类型';
...
$_LANG['tab_mix'] = '其他信息';
$_LANG['tab_properties'] = '图库属性';
$_LANG['tab_gallery'] = '图库相册';
$_LANG['tab_linkgoods'] = '关联图库';
$_LANG['tab_groupgoods'] = '配件';
$_LANG['tab_article'] = '关联文章';

$_LANG['lab_goods_name'] = '图库名称：';
$_LANG['lab_goods_sn'] = '图库货号：';
$_LANG['lab_goods_cat'] = '图库分类：';
$_LANG['lab_other_cat'] = '扩展分类：';
$_LANG['lab_goods_brand'] = '图库品牌：';
...
$_LANG['lab_picture'] = '上传图库图片：';
$_LANG['lab_thumb'] = '上传图库缩略图：';
$_LANG['auto_thumb'] = '自动生成图库缩略图';
$_LANG['lab_keywords'] = '图库关键词：';
$_LANG['lab_goods_brief'] = '图库简单描述：';
$_LANG['lab_seller_note'] = '商家备注：';
$_LANG['lab_goods_type'] = '图库类型：';
$_LANG['Preview'] = '预览';
$_LANG['lab_picture_url'] = '图库图片外部URL';
$_LANG['lab_thumb_url'] = '图库缩略图外部URL';
...
$_LANG['lab_goods_weight'] = '图库重量：';
$_LANG['unit_g'] = '克';
$_LANG['unit_kg'] = '千克';
$_LANG['lab_goods_number'] = '图库库存数量：';
...
$_LANG['lab_is_alone_sale'] = '能作为普通图库销售：';
$_LANG['lab_is_free_shipping'] = '是否为免运费图库';
$_LANG['compute_by_mp'] = '按市场价计算';
$_LANG['label_account_bind'] = '账户绑定';
$_LANG['notice_goods_sn'] = '如果您不输入图库货号，系统将自动生成一个唯一的货号。';
$_LANG['notice_integral'] = '(此处需填写金额)购买该图库时最多可以使用积分的金额';
$_LANG['notice_give_integral'] = '购买该图库时赠送消费积分数,-1表示按图库价格赠送';
$_LANG['notice_rank_integral'] = '购买该图库时赠送等级积分数,-1表示按图库价格赠送';
$_LANG['notice_seller_note'] = '仅供商家自己看的信息';
$_LANG['notice_storage'] = '库存在图库为虚货或图库存在货品时为不可编辑状态，库存数值取决于其虚货数量或货品数量';
$_LANG['notice_keywords'] = '用空格分隔';
$_LANG['notice_user_price'] = '会员价格为-1时表示会员价格按会员等级折扣率计算。你也可以为每个等级指定一个固定价格';
$_LANG['notice_goods_type'] = '请选择图库的所属类型，进而完善此图库的属性';

$_LANG['on_sale_desc'] = '打勾表示允许销售，否则不允许销售。';
$_LANG['alone_sale'] = '打勾表示能作为普通图库销售，否则只能作为配件或赠品销售。';
$_LANG['free_shipping'] = '打勾表示此图库不会产生运费花销，否则按照正常运费计算。';

$_LANG['invalid_goods_img'] = '图库图片格式不正确！';
$_LANG['invalid_goods_thumb'] = '图库缩略图格式不正确！';
$_LANG['invalid_img_url'] = '图库相册中第%s个图片格式不正确!';

$_LANG['goods_img_too_big'] = '图库图片文件太大了（最大值：%s），无法上传。';
$_LANG['goods_thumb_too_big'] = '图库缩略图文件太大了（最大值：%s），无法上传。';
$_LANG['img_url_too_big'] = '图库相册中第%s个图片文件太大了（最大值：%s），无法上传。';
...
$_LANG['suppliers_no']             = '不指定供货商属于本店图库';
...
$_LANG['all_goods'] = '可选图库';
$_LANG['link_goods'] = '跟该图库关联的图库';
$_LANG['single'] = '单向关联';
$_LANG['double'] = '双向关联';
$_LANG['all_article'] = '可选文章';
$_LANG['goods_article'] = '跟该图库关联的文章';
$_LANG['top_cat'] = '顶级分类';
...
$_LANG['goods_not_exist'] = '该图库不存在';
$_LANG['goods_not_in_recycle_bin'] = '该图库尚未放入回收站，不能删除';

$_LANG['js_languages']['goods_name_not_null'] = '图库名称不能为空。';
$_LANG['js_languages']['goods_cat_not_null'] = '图库分类必须选择。';
$_LANG['js_languages']['category_cat_not_null'] = '分类名称不能为空';
$_LANG['js_languages']['brand_cat_not_null'] = '品牌名称不能为空';
$_LANG['js_languages']['goods_cat_not_leaf'] = '您选择的图库分类不是底级分类，请选择底级分类。';
...
$_LANG['js_languages']['goods_number_not_int'] = '图库库存不是整数';
...
$_LANG['js_languages']['batch_no_on_sale'] = '您确实要将选定的图库下架吗？';
$_LANG['js_languages']['batch_trash_confirm'] = '您确实要把选中的图库放入回收站吗？';
$_LANG['js_languages']['go_category_page'] = '本页数据将丢失，确认要去图库分类页添加分类吗？';
$_LANG['js_languages']['go_brand_page'] = '本页数据将丢失，确认要去图库品牌页添加品牌吗？';
...
$_LANG['goods_number_error'] = '图库库存数量错误';
$_LANG['virtual_sales_error'] = '图库虚拟销售数量错误';
...
$_LANG['products_title'] = '图库名称：%s';
$_LANG['products_title_2'] = '货号：%s';
$_LANG['good_shop_price'] = '（图库价格：%d）';
$_LANG['good_goods_sn'] = '（图库货号：%s）';
...
$_LANG['cannot_goods_number'] = '此图库存在货品，不能修改图库库存';
$_LANG['not_exist_goods_attr'] = '此图库不存在规格，请为其添加规格';
$_LANG['goods_sn_exists'] = '您输入的货号已存在，请换一个';
