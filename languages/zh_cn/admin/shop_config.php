...
$_LANG['cfg_name']['qq'] = '分享地址';
//$_LANG['cfg_name']['ww'] = '淘宝旺旺';
$_LANG['cfg_name']['ww'] = '兑换卡地址';
//$_LANG['cfg_name']['skype'] = 'Skype';
$_LANG['cfg_name']['skype'] = '充值地址';
...
$_LANG['cfg_name']['share_title'] = '转发标题';
$_LANG['cfg_desc']['share_title'] = '用于H5/小程序在微信环境下转发显示的标题（商品详情页转发除外）';

$_LANG['cfg_name']['share_desc'] = '转发描述';
$_LANG['cfg_desc']['share_desc'] = '用于H5在微信环境下转发显示的内容（商品详情页转发除外）';
